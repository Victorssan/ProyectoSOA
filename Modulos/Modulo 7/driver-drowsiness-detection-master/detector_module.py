...
ecal_core.initialize([], "Python Somnolencia Detector Publisher")
pub = ProtoPublisher("somnolencia_data", mensaje_main_pb2.Somnolencia)
...
while True:
    ...
    protobuf_message = mensaje_main_pb2.Somnolencia()
    protobuf_message.avgEAR = avgEAR

    # Indicador de alerta
    if avgEAR < close_thresh:
        protobuf_message.alert = True
    else:
        protobuf_message.alert = False
